document.addEventListener('DOMContentLoaded', () => {
     ...
     /* =========================================================
        OUR LEAD PARTNERS & THEIR SERVICES: INTERACTIVITY
        ========================================================= */
     const filterTabs = document.querySelectorAll('.partners-filter-group .filter-tab');
     const partnerCards = document.querySelectorAll('.partners-grid .partner-card');
     const partnerTableRows = document.querySelectorAll('#partnersTableBody tr');
     const gridViewBtn = document.getElementById('partnersGridViewBtn');
     const tableViewBtn = document.getElementById('partnersTableViewBtn');
     const partnersGrid = document.getElementById('partnersGrid');
     const partnersTableWrapper = document.getElementById('partnersTableWrapper');

     // Category Filtering with Smooth Staggered Animation
     if (filterTabs.length > 0) {
         filterTabs.forEach((tab) => {
             tab.addEventListener('click', () => {
                 ...
                 // Filter Partner Cards with smooth stagger
                 let visibleIndex = 0;
                 partnerCards.forEach((card) => {
                     ...
                     if (filterValue === 'all' || category === filterValue) {
                         ...
                         void card.offsetWidth; // Force reflow to re-trigger smooth animation
                 ...
                 // Filter Table Rows with smooth fade
     ...
     // View Toggle: Cards Grid vs Table Directory with Smooth Transition
     if (gridViewBtn && tableViewBtn && partnersGrid && partnersTableWrapper) {
         gridViewBtn.addEventListener('click', () => {
             if (gridViewBtn.classList.contains('active')) return;
             gridViewBtn.classList.add('active');
             tableViewBtn.classList.remove('active');
             partnersTableWrapper.style.display = 'none';
             partnersGrid.style.display = 'grid';
             partnersGrid.classList.remove('is-filtering');
             void partnersGrid.offsetWidth;
             partnersGrid.classList.add('is-filtering');
         });
         ...
         tableViewBtn.addEventListener('click', () => {
             ...
             partnersTableWrapper.style.display = 'block';
             partnersTableWrapper.classList.remove('is-filtering');
             void partnersTableWrapper.offsetWidth;
             partnersTableWrapper.classList.add('is-filtering');
         });
     }
});
